...
{
    const string BalanceUrl = "https://www.alreadyordered.no/compass149002/content/uncode-lite_child/TemplateProductTable_find_current_top_up_value.php";
    const string TopUpUrl = "https://www.alreadyordered.no/compass149002/content/uncode-lite_child/TemplateProductTable_pure.php";
    ...
    static async Task<int> AsyncMain(string[] args)
    {
        ...
        await AutoUpdater.CheckAndApplyUpdateAsync();
        return 0;
    }
